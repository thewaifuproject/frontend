                ...
                <div className="blog-slider__wrp swiper-wrapper">
                    <div className="blog-slider__item swiper-slide">
                        ...
                        <div class="blog-slider__content">
                            ...
                            <a class="blog-slider__button" onClick={() => goTo(7)}>👌🏿</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="blog-slider">
                <div className="blog-slider__wrp swiper-wrapper">
                    <div className="blog-slider__item swiper-slide">
                        ...
                        <div class="blog-slider__content">
                            <div class="blog-slider__text" id="dialog">Once you have seen your <strike>fap</strike> fav waifu, it’s time to bid!</div>
            ...
            <div className="blog-slider__wrp swiper-wrapper">
                <div className="blog-slider__item swiper-slide">
                    ...
                    <div class="blog-slider__content">
                        ...
                        <a class="blog-slider__button" onClick={() => goTo(3)}>👍🏿</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="blog-slider__wrp swiper-wrapper">
                <div className="blog-slider__item swiper-slide">
                    ...
                    <div class="blog-slider__content">
                        ...
                        <a class="blog-slider__button" onClick={() => goTo(12)}>👌🏿</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="blog-slider__wrp swiper-wrapper">
                <div className="blog-slider__item swiper-slide">
                    ...
                    <div class="blog-slider__content">
                        ...
                        <a class="blog-slider__button" onClick={() => goTo(13)}>👌🏿</a>
                    </div>
                </div>
            </div>
        </div>
